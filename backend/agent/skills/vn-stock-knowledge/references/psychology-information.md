...
Tầng lý thuyết phía sau việc đọc hành vi thị trường: thông tin bất cân xứng vận hành thế nào, tài chính hành vi phát biểu gì, lý thuyết trò chơi soi sáng động cơ từng bên ra sao. File này giải thích **cơ chế**; phần đọc tâm lý thực hành nằm ở `vn-stock-advisor/references/market-behavior.md`, file này không lặp lại.
