...
**CAPM chỉ có một nhân tố**: thị trường, truyền vào cổ phiếu qua beta (công thức và cách lấy từng biến ở `valuation.md`, mục *Tỷ suất chiết khấu: CAPM và WACC*). Thực tế giá còn chịu hàng loạt biến vĩ mô và vi mô khác, nên giới nghiên cứu mở rộng sang mô hình nhiều nhân tố.
...
Hai kỹ thuật rào chắn vị thế cổ phiếu: **rebalancing** — mua bán **cùng một lượng** cổ phiếu quanh vùng hỗ trợ/kháng cự để cơ cấu lại vị thế mà không đổi số cổ phiếu nắm giữ (chi tiết ở `portfolio-and-rotation.md`, mục *Rebalancing*); và **hedging bằng hợp đồng tương lai** — mở vị thế phái sinh ngược chiều để trung hòa rủi ro thị trường của danh mục, toàn bộ phần dưới.
