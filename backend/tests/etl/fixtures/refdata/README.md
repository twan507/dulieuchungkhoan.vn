...
| `organization.json` | 8 dòng: ACV(ACVN) · VHM(NHN) · SHB(SHB,NH) · CLI(0106839469) · NCG(ANOVA) · FUEMAVND(2172623,QU) · EGL · FUCTVGF4 (2 org-only) | **đúng 1** CP không có org ⇒ issuer NULL: `HTB` *(sửa 2026-08-26 đêm — bản đầu đếm 2 vì tính cả `L40_WFT_01`, dòng rác bị chính normalize lọc; T3 bắt được bằng giải tay)* |
