...
**Bảng phân loại bốn loại khoảng trống, hai tiêu chí phân biệt, và giới hạn của gap ở thị trường có biên độ trong ngày nằm ở `technical-indicators.md`, mục *Khoảng trống giá, đột phá, ba kiểu mua*** — file này không lặp lại.
