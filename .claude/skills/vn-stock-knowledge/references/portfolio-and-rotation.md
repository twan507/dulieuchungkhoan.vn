...
Tầng cơ chế của việc dựng danh mục: phân bậc rủi ro cổ phiếu bằng tiêu chí đo được, phân bổ tỷ trọng bằng công thức, và đọc trật tự tiền chảy giữa các ngành lẫn các bậc dòng tiền. Phần tư duy top-down và chu kỳ chính sách nằm ở `vn-stock-advisor/references/analysis-framework.md`, file này không lặp lại.
...
Ba lý thuyết mua phổ biến, không phải bí kíp riêng của ai: **mua hỗ trợ**, **mua đột phá (breakout)**, **mua theo đà (momentum)**. Bảng cách làm và đặc điểm từng kiểu nằm ở `technical-indicators.md`, mục *Khoảng trống giá, đột phá, ba kiểu mua* — không lặp lại ở đây. Ba điểm bổ sung khi chọn cách mua cho một danh mục:
...
**Chiều thực hiện:** tại vùng kháng cự thì **bán trước mua sau**; tại vùng hỗ trợ thì **mua trước bán sau**. **Khung quan sát và tín hiệu:** dùng nến 30 phút (lý do chọn khung này, và nguyên tắc chỉ hành động ở nhịp thứ hai trước một vùng quan trọng, ở `technical-indicators.md`, mục *Tham số và khung thời gian*). Ba tín hiệu cần nhìn: mẫu hình phân kỳ, các mẫu nến (rút chân, engulfing), tương quan giá–khối lượng. Ở khung này yếu tố cơ bản chưa kịp đổi nên tâm lý chi phối — nhưng tin cơ bản vẫn phải theo dõi vì nó tác động tâm lý tức thì, và đọc nến phiên kế tiếp luôn phải đặt trong bối cảnh hỗ trợ/kháng cự, tách khỏi bối cảnh thì rỗng.
...
- Hai quy tắc hành động rút ra từ phân biệt này — "rủi ro cao lợi nhuận cao" hiểu theo hai chiều, và hai nguyên tắc người ta hay làm ngược — nằm ở `vn-stock-advisor/references/analysis-framework.md`, mục *Nguyên tắc vào/ra và tỷ trọng*.
