...
|---|---|---|
| [00-conventions.md](market/00-conventions.md) | **Đọc trước tiên.** Base URL, xác thực, cấu trúc response, xử lý lỗi, kiểu dữ liệu, đơn vị, và 9 bẫy triển khai | — |
