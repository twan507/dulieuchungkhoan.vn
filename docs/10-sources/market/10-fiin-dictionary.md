...
dulieuchungkhoan.vn chỉ lưu **80/193 trường** (ước lượng 2026-08-14; đếm 2026-09-03: 81/193 sau khi lưu thêm 4 mã `cần kiểm API`). 113 trường bị bỏ vì trùng BVSC, trùng BCTC, hoặc tính lại được từ giá; 20 trường nhóm chấm điểm bỏ theo quyết định của chủ dự án; số còn lại là metadata không dùng.
