...
**Ngày:** 2026-08-14 · **Trạng thái:** đã áp dụng · **Thay thế** [ADR 0001](0001-cau-truc-kho-tai-lieu.md) §6
...
Thay bằng [`30-tri-thuc/bao-tri-skill.md`](../../30-tri-thuc/bao-tri-skill.md): **140 dòng thay cho 529 dòng**. Chỉ giữ thứ mà sửa nhầm sẽ làm hỏng skill:
...
- Trùng lặp luật phân tầng L1/L2 giữa hai file đã hết — nay chỉ nằm ở [`30-tri-thuc/README.md`](../../30-tri-thuc/README.md).
