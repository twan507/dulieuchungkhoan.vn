...
| [`2026-08-28-post-session-sequence/`](plans/2026-08-28-post-session-sequence/) | **Chuỗi việc sau phiên 28/08** — bản điều phối: đóng AC3 của lát tràn-ra-đĩa · đăng ký lại 7 task với `-LogonType S4U` (kèm sửa script) · luật huỷ niêm yết · chạy trọn bộ test · hai khoản nợ nhỏ · dọn nhánh và đẩy origin — `plan.md` | 🟡 **chờ cửa sổ sau 15:10** — gom lại làm một lượt vì đụng ingester, 7 task Scheduler và DB thật |
