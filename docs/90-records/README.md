...
| [`2026-08-24-deploy-scaffold/`](plans/2026-08-24-deploy-scaffold/) | Khung đóng gói một-nút (docker compose infra/app · `stack.mjs` · dev native + deploy docker) — học tinh hoa từ tutor-agent — `spec.md` | 🔨 spec xong; plan + thực thi chưa |
