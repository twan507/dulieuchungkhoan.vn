...
| [`2026-08-28-ingester-spill-to-disk/`](plans/2026-08-28-ingester-spill-to-disk/) | **Hàng đợi ghi có trần, tràn ra đĩa** — đóng chỗ hở `pending` không trần (ATO + CH trục trặc → OOM mất im lặng): hai vòng quản/ghi tách biệt, hai cửa vào chế độ đĩa, file pickle hai loại `-r`/`-n`, bộ đếm `d[]` làm nghiệm thu bằng số — `brief.md` · `spec.md` · `review-2026-08-27.md` · `plan.md` · `ledger.md` | 🟡 **Phase A (đo, gate N/K/trần đĩa) + Phase B (cơ chế) code xong 2026-08-27 tối** — AC2 (chaos, `docker stop` thật) PASS: 200.000 fed / stored, 0 dup, RSS đỉnh 78,7 MB, 253 block spill+replay; suite 156 passed 1 skipped. **Chờ AC3** (hằng đẳng thức sổ sách một phiên thật) — phiên 28/08 |
