...
| [`2026-09-03-events-daily-etl/`](plans/2026-09-03-events-daily-etl/) | **Lát 2 của [7] ETL hằng ngày — lịch sự kiện** — sáu họ `Calendar/GetCorporate*` → `market.corporate_event`. Lát này đứng trước lát giá và lát snapshot vì nó **mở khoá** trigger cho cả hai — `measurements.md` · `samples/` (bằng chứng đo) | 🟡 **đang thiết kế, chưa có spec.** Lượt đo nguồn 2026-09-03 (46 lời gọi thật) đã đóng 5/6 câu hỏi và lật hai giả định: `FromDate` lọc theo **trục ngày khác nhau ở mỗi họ** (Earning thì lọc theo trường không có trong response — cửa sổ bỏ sót tới 195/217 bản ghi), và khoá tự nhiên 7 cột của migration `0004` **đụng 211 khoá / 193 khác nội dung** |
