...
*Kiểm lại 05:33 ngày 05/09 (thứ 7): `GetSnapshotNoneBank` AAA vẫn 7.090, ABB 17.204 — giá 03/09; trong khi `getPriceData` AAA đã có phiên 04/09 = 7.130 từ chiều hôm trước. Sau 14,5 giờ họ Snapshot vẫn chưa nạp ⇒ không phải "qua đêm" mà là **theo ngày làm việc kế tiếp** (hoặc muộn hơn); mốc chính xác đo được khi giá đổi. AC5 dời tới khi AAA ≠ 7.090 — sớm nhất thứ 2 07/09. Hệ quả cho lát 13: job `snapshot` đọc giá trễ ≥ 1 ngày so với `price`, tập trắng hash không chứa trường giá nên không ảnh hưởng "ghi khi đổi".*


## 5. AC5 — đo 2026-09-05 08:19 (thứ 7, sau lát 6): nửa jitter ĐÓNG, nửa giá vẫn chờ nguồn
