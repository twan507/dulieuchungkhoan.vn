...
**Cả bộ trên `main` `5e3c72a` (19:03):** `uv run pytest tests -q` → **1214 passed, 3 skipped in 96.99s**. Docs khép: `2b281da`. Push `origin/main` ngay sau dòng này; nhánh `feat/etl-scheduler` xoá cục bộ (chưa từng đẩy lên remote).
