...
| **4d** | **Bật lại 4 task OMO** — ⏸️ `Disabled` từ **2026-08-28 15:04** *(quyết định chủ dự án: giai đoạn này ưu tiên dev, đã test đủ)*. 🔴 **Điều kiện bật lại, chốt 2026-08-28: khi [7] ETL hằng ngày chạy ổn định.** Đó là một *điều kiện*, không phải một ngày — nên kèm **mốc rà cứng 2026-09-15**: tới đó chưa bật thì phải quyết lại, đừng để trôi tiếp. Bật lại: `Get-ScheduledTask -TaskName "dlck-omo-*" | Enable-ScheduledTask` | SBV **không cho backfill** — chỉ hiển thị phiên mới nhất, không có kho lưu *(`sbv-omo.md` Giới hạn 1)* ⇒ mỗi ngày làm việc kể từ **29/08** là một phiên mất hẳn. Và cột **đáo hạn/bơm ròng phải tự dựng** từ kỳ hạn, cần **~140 ngày tích luỹ** mới có số ròng đầy đủ ⇒ mỗi ngày tắt còn đẩy lùi luôn mốc đó |
