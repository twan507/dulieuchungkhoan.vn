...
lát 6   vĩ mô WiChart            87 key vĩ mô + hàng hoá → macro.observation (10-sources/macro/wichart.md; 6 bẫy: epoch giờ VN,
                                   15 series sai nhãn đơn vị 1000 lần ⇒ bảng hệ số hardcode). TIẾP THEO.
