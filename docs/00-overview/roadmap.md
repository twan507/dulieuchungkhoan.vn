...
lát 6   vĩ mô WiChart            87 key (66 thu thập, 21 Tier X) → macro.observation (25 key vĩ mô/tiền tệ) + asset.price_daily
                                   (dhtg 5 tỷ giá + 61 hàng hoá) theo luật phân miền bước 4 §0 (10-sources/macro/wichart.md; 6 bẫy:
                                   epoch giờ VN, 15 series sai nhãn đơn vị 1000 lần ⇒ bảng hệ số hardcode). TIẾP THEO.
...
### Điểm vào cho lát 6 — vĩ mô WiChart, đọc trước khi bắt đầu
