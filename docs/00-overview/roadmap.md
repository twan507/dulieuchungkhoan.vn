...
**Chi phí:** **93 MB gzip một ngày** *(đo 2026-08-27, trọn phiên)* ≈ 23 GB/năm nếu giữ hết — nên **phải kèm chính sách xoá**, không giữ vô hạn. Đĩa VPS 60 GB không gánh nổi bản thô vô thời hạn. ✅ **Đã cài giữ 30 ngày** (≈ 2,8 GB thường trực); khi lát tràn-ra-đĩa xong có thể rút xuống vài ngày — đổi hằng số `KEEP_DAYS` trong `backend/ingester/measure.py`.
