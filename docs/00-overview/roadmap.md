...
**Trạng thái bàn giao 2026-09-05 ~08:30:** `main` = lát 6 · **639 test xanh, 2 skipped** · migration head `0017` · `macro.indicator` 53 · `asset.asset` 52 · `macro.observation` 10.505 · `asset.price_daily` 27.124 · `data_domain_state`: `macro.indicator`/wichart và `asset`/wichart = `2026-09-05` · 10/11 task `Disabled`, `dlck-price-backfill` `Ready` (lượt 00:05 thứ 7 chết vì `SourceDown`, chưa kích lại) · AC5 lát 4 treo tới thứ 2 07/09.
