...
Hai skill xong, test 6 vòng, đã dừng tối ưu theo tiêu chí *"hai vòng liên tiếp không tìm thấy lỗi trong tầm skill"*. Việc còn lại duy nhất liên quan tới skill nằm ở **tầng sản phẩm, không phải tầng skill**: dán đoạn giới hạn phạm vi vào system prompt khi dựng backend — xem [kiến trúc tổng thể §4](../architecture.md).
...
|---|---|
| Phần A — chữ sau khi sửa | Chính trong 2 skill; lý do ở [`bao-tri-skill.md`](../../30-skills/maintenance.md) §2 |
| Phần A — 4 chỗ nêu tên ngành **không được gỡ nhầm** | [`30-tri-thuc/README.md`](../../30-skills/README.md) §*Ba điều dễ làm hỏng skill*, mục 1 |
| A9 và B11 | ADR này, mục 2 và 3 |
| B3, B4, B9, B10, B6 — quyết **giữ nguyên**, có lý do | [`30-tri-thuc/README.md`](../../30-skills/README.md) §*Năm thứ trông như lỗi nhưng là cố ý* |
...
- Bốn nhóm "cố ý, đừng sửa" chuyển từ một bảng rà soát dùng một lần sang [`30-tri-thuc/README.md`](../../30-skills/README.md) — chỗ mà luật kho quy định phải đọc **trước mọi thay đổi nội dung skill**. Trước đây chúng nằm ở file mà không ai có lý do đọc lại.
