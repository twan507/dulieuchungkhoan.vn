...
**Ngày:** 2026-08-14 · **Trạng thái:** dự án đã đóng — [ADR 0003](../00-tong-quan/quyet-dinh/0003-dong-du-an-skill.md)
...
Bảng thuật ngữ đi kèm là [`thuat-ngu.md`](thuat-ngu.md) — bắt buộc, không phải tham khảo.
...
| | Quy mô | Kiểm chứng |
|---|---:|---|
| `co-van-chung-khoan-vn` (L1) | 774 dòng | 5 vòng test riêng, hội tụ 250–275 chữ |
| `kien-thuc-chung-khoan-vn` (L2) | 2.272 dòng | bao phủ cơ học **342/342** tiêu đề section gốc |
...
Và một chỗ đã cân nhắc riêng rồi quyết **giữ**: *"ngân hàng đứng đầu xếp hạng an toàn nhưng hút tiền đầu tiên → **ngành báo hiệu**"* ở [`danh-muc-va-luan-chuyen.md`](../../.claude/skills/kien-thuc-chung-khoan-vn/references/danh-muc-va-luan-chuyen.md). Đây là **cơ chế**, không phải danh sách — [ADR 0003](../00-tong-quan/quyet-dinh/0003-dong-du-an-skill.md) §2.
...
| **"Hành động ở nhịp 2" vs "quan sát từ điểm chạm thứ 3"** | Hai phép đếm khác nhau, **tình cờ dùng chung con số**: *nhịp* là lần phản ứng tâm lý trước một vùng giá; *điểm chạm* là số lần giá uốn lại ở một đường của mẫu hình. Câu phân biệt đã đặt tại chỗ trong `ky-thuat-chi-bao.md` |
...
🔴 **Corpus có thể khuếch đại nhiễu nhận dạng giọng nói** — một từ nghe nhầm xuất hiện 1 lần trong transcript thành thuật ngữ dùng 10 lần trong bản tóm tắt. Đã xảy ra thật với «nội giải». Gặp thuật ngữ nghe lạ thì đối chiếu ngược transcript, mà transcript nay chỉ còn ở **bản lưu trữ ngoài repo** — xem [ADR 0001](../00-tong-quan/quyet-dinh/0001-cau-truc-kho-tai-lieu.md).
