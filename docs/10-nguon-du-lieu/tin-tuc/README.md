...
Tài liệu này mô tả **nguồn tin có gì và cư xử thế nào** — 47 feed RSS, 6 nguồn crawl HTML, encoding, định dạng thời gian, khối lượng đo được, và những nguồn đã loại. Phần *Finext quyết định xử lý ra sao* nằm ở [thiết kế pipeline tin tức](../../20-thiet-ke/pipeline-tin-tuc.md).
...
> | Mục | File |
> |---|---|
> | 1 Tổng quan · 2 Kiến trúc · 3 Taxonomy | [thiết kế](../../20-thiet-ke/pipeline-tin-tuc.md) |
> | **4 Danh sách 47 feed · 5 Sáu nguồn crawl · 6 Quy tắc chuẩn hoá** | **file này** |
> | 7 Quy tắc phân loại · 8 Gắn mã cổ phiếu · 9 Kho lưu trữ · 10 Giám sát | [thiết kế](../../20-thiet-ke/pipeline-tin-tuc.md) |
> | **11.1–11.3 Nguồn và feed đã loại** | **file này** |
> | 11.4 Ý tưởng thiết kế bị loại · 12 Còn để ngỏ · 14 Trạng thái | [thiết kế](../../20-thiet-ke/pipeline-tin-tuc.md) |
> | **13 Khối lượng đã đo** | **file này** |

**File máy đọc đi kèm:** [`config/feeds.json`](../../../config/feeds.json) — 47 feed, taxonomy 20 sub, nhật ký loại bỏ.
