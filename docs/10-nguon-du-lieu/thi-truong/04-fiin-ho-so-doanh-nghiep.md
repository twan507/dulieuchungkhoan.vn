...
Lấy `comTypeCode` từ [`getListOrganization`](03-fiin-tham-chieu.md).
...
| `rtq10` `rtq12` `rtq14` `rtq29` | number | — | Nhóm chỉ số TTM — `rtq12` = ROE, `rtq14` = ROA. Xem [Phụ lục A](phu-luc-A-ma-field.md) |
...
Tiền tố quyết định nhóm chỉ tiêu — xem [Phụ lục A](phu-luc-A-ma-field.md):
...
### Ghi chú
Bốn điểm chữ cái chỉ là kết quả tổng hợp. Muốn biết **vì sao** một mã bị điểm `F`, phải gọi [`getRateIndicator`](06-fiin-cham-diem-dinh-gia.md) để bung ra 32 chỉ tiêu thành phần.
