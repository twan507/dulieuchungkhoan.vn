...
1. **Ánh xạ `ticker → organCode`** — bắt buộc để gọi mọi API FiinTrade khác (xem [Bẫy 1](00-quy-uoc-chung.md))
2. **`comTypeCode`** — quyết định chọn `GetSnapshot` hay `GetSnapshotNoneBank` (xem [Bẫy 3](00-quy-uoc-chung.md))
