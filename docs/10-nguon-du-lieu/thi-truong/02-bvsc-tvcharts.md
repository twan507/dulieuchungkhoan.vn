...
→ Muốn lịch sử sâu hơn 1 năm, bắt buộc dùng [`getPriceData`](09-fiin-gia-thi-truong.md) của FiinTrade (phân trang tới ~12,5 năm).
...
| `/marks` | `404` | Không có marker sự kiện trên biểu đồ. Muốn có phải tự vẽ từ [`Calendar/GetCorporate*`](08-fiin-lich-su-kien.md) |
