...
**Tổng cộng 729 mã — 98,5% có tên tiếng Việt, 98,5% có tên tiếng Anh.** Bảng đầy đủ dạng máy đọc: [tu-dien-ma-field.json](tu-dien-ma-field.json).

Hai nguồn giải mã:

| Họ mã | Nguồn | Số mã | Có `unit`? | Xem |
|---|---|---:|---|---|
| `rtd*` `rtq*` `rqq*` `ryq*` `rsd*` `rsq*` | [`Screener/GetScreenerParameters`](10-fiin-tu-dien.md) — API trả `code → name → unit`, **83 mã**. Phần còn lại lấy từ bundle | 173 | ⚠️ chỉ 83 | **A.3** · **A.5** |
...
**Đo ngày 2026-08-14.** Bảng đầy đủ ở dạng máy đọc: [tu-dien-ma-field.json](tu-dien-ma-field.json) — **729 mã, 98,5% có tên tiếng Việt**.
