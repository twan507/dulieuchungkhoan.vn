...
Tra nghĩa từng mã: [Phụ lục A §A.5](phu-luc-A-ma-field.md) — **729 mã đã giải mã, độ phủ 100% trên response thật**, kèm bảng [tu-dien-ma-field.json](tu-dien-ma-field.json).
