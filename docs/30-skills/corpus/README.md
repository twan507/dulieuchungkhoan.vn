...
**1 · Đây là bản tóm tắt, không phải bản gốc.** Transcript verbatim (`documents/`) đã đưa ra khỏi repo, chỉ còn ở bản lưu trữ ngoài.
...
Ngân sách dòng đo thật và luật *"vượt thì nén đâu, không được cắt đâu"*: [maintenance.md §8](../maintenance.md). Bản đồ chi tiết 355 section → 8 file skill là tài liệu trung gian của Giai đoạn 1, đã bỏ khi dự án đóng vì hết hạn — còn ở commit `a14eb54`.
