...
- Gán hàng loạt bằng `industry_icb_map` — nội dung ở [industry-mapping.md](industry-mapping.md). **Trộn hai cấp ICB có chủ đích**: 40 dòng cấp 3 làm nền cho cả nhánh, cộng 16 dòng cấp 4 cho những nhánh chứa từ hai ngành riêng trở lên. Luật phân giải *(DDL 0002)*: khớp `icb_code` chính xác trước, không có thì leo `icb_code_path` lấy tổ tiên gần nhất — nên dòng cấp 4 **thắng** dòng cấp 3 cùng nhánh, còn dòng cấp 3 đón cả mã ICB lá mới chưa từng thấy. Nhờ đó 24 ngành phủ **1.526/1.526** cổ phiếu có doanh nghiệp *(đo 2026-08-27)*.
