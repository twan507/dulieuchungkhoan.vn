...
│   └── tests/           442 test, chạy trên Postgres/ClickHouse/Redis THẬT
...
4. `cd backend && uv run pytest tests` — kỳ vọng **442 passed, 2 skipped** *(đo 2026-09-04)* *(hai skip là probe thủ công có cổng env: `RUN_PROBE`, `RUN_CHAOS`)*.
